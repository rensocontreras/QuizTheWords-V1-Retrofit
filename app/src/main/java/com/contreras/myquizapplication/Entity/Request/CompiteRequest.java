...
public class CompiteRequest {
    ...
    public int getTxt_estado_candado() {
        return txt_estado_candado;
    }

    public void setTxt_estado_candado(int txt_estado_candado) {
        this.txt_estado_candado = txt_estado_candado;
    }
