...
public class LoginActivity extends AppCompatActivity implements Validator.ValidationListener, ILogin.ILoginView {
    ...
    private void guardarPreferenciaUsuario(int codigoUsuario, String nombreUsuario) {
    ...
    @Override
    public void mostrarResultadoCorrecto(int codigoUsuario, String nombreUsuario) {
        guardarPreferenciaUsuario(codigoUsuario,nombreUsuario);
        finish();
